...
if exist "E:\Work\Test2\sbao-fcm-interstage2-mpi\sbao-interstage2\example\newDB\1864\sample.1864\Nastran\Interstage.bdf" del "E:\Work\Test2\sbao-fcm-interstage2-mpi\sbao-interstage2\example\newDB\1864\sample.1864\Nastran\Interstage.bdf"
"C:/Program Files/Altair/14.0/hm/bin/win64/hmbatch.exe" -tcl All_Aluminum.new.tcl
if exist "E:\Work\Test2\sbao-fcm-interstage2-mpi\sbao-interstage2\example\newDB\1864\sample.1864\Nastran\Interstage.bdf" exit /b 0
set /a nex+=1
